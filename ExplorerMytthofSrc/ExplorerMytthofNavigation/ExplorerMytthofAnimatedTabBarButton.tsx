...
const AnimatedTabBarButton = ({
  ...
  return (
    <Pressable
      ...
      style={[explorerMytthofStyles.explorerMytthofButton, style as StyleProp<ViewStyle>]}>
      <Animated.View style={[explorerMytthofStyles.explorerMytthofContent, {transform: [{scale}]}]}>
        {children}
      </Animated.View>
    </Pressable>
  );
...
const explorerMytthofStyles = StyleSheet.create({
  explorerMytthofButton: {
    flex: 1,
    alignItems: 'center',
    justifyContent: 'center',
  },
  explorerMytthofContent: {
    alignItems: 'center',
    justifyContent: 'center',
  },
});
