...
import type {MythLocale, ChronicleEntry, BranchScript} from '../../ExplorerMytthofTypes';

const chronicleVisuals: Record<string, ImageSourcePropType> = {
  'tale-01': require('../../../elements/images/stories/greeceDelphi.png'),
  'tale-02': require('../../../elements/images/stories/egyptFalcon.png'),
  'tale-03': require('../../../elements/images/stories/indiaMoonRiver.png'),
  'tale-04': require('../../../elements/images/stories/aztecsRedSky.png'),
  'tale-05': require('../../../elements/images/stories/greeceShipwreck.png'),
  'tale-06': require('../../../elements/images/stories/egyptObsidianGate.png'),
  'tale-07': require('../../../elements/images/stories/indiaTigerTemple.png'),
  'tale-08': require('../../../elements/images/stories/aztecsUndergroundCity.png'),
  'tale-09': require('../../../elements/images/stories/greeceSilverHarp.png'),
  'tale-10': require('../../../elements/images/stories/egyptMoonTomb.png'),
  'tale-11': require('../../../elements/images/stories/indiaEmeraldPalace.png'),
  'tale-12': require('../../../elements/images/stories/aztecsGoldenEclipse.png'),
};
