...
} from '../data/legendsaventurebkkStoriesData';
import type {LegendsaventurebkkStoriesView, LegendsaventurebkkStory} from '../types';
import {
...
const TalesScreen = () => {
  ...
  const [legendsaventurebkkHistory, setLegendsaventurebkkHistory] = useState<
    string[]
  >([]);
  const [legendsaventurebkkSaved, setLegendsaventurebkkSaved] =
    useState(false);
  ...
  const legendsaventurebkkNode =
    legendsaventurebkkStory?.legendsaventurebkkNodes[
      legendsaventurebkkNodeId
    ];
  ...
  const legendsaventurebkkOpenStory = useCallback(
    async (legendsaventurebkkId: string) => {
      const legendsaventurebkkItem = legendsaventurebkkGetStoryById(
  ...
  return (
    <AppLayout
      tab
      contentStyle={styles.legendsaventurebkkReaderScroll}>
      <Pressable
        ...
        <View style={styles.legendsaventurebkkCompleteBlock}>
          ...
          <Pressable
            ...
            style={({pressed}) => [
              ...
              legendsaventurebkkSaved &&
                styles.legendsaventurebkkSaveDisabled,
              pressed &&
                !legendsaventurebkkSaved &&
