...
import {legendsaventurebkkCharacters} from '../data/legendsaventurebkkCharactersData';
...
const CharactersScreen = () => {
  ...
  const legendsaventurebkkReload = useCallback(async () => {
    setLegendsaventurebkkTalesRead(
      await legendsaventurebkkGetTalesReadCount(),
    );
  }, []);
  ...
  const {legendsaventurebkkUnlocked, legendsaventurebkkLocked} =
    useMemo(() => {
