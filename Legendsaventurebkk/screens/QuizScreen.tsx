...
} from '../data/legendsaventurebkkQuizData';
import type {
...
const QuizScreen = () => {
  ...
  const [legendsaventurebkkCorrect, setLegendsaventurebkkCorrect] =
    useState(0);
  const [legendsaventurebkkSelected, setLegendsaventurebkkSelected] =
  ...
  if (legendsaventurebkkView === 'play' && legendsaventurebkkCurrent) {
    return (
      <AppLayout
        tab
        contentStyle={styles.legendsaventurebkkPlayScroll}>
