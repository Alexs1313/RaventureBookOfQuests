...
import type {RadienceffAncienttalesMythLocale, RadienceffAncienttalesChronicleEntry, RadienceffAncienttalesBranchScript} from '../../RadienceffAncienttalesTypes';

const chronicleVisuals: Record<string, ImageSourcePropType> = {
  'tale-01': require('../../../../../elements/images/greece_oracle_temple.png'),
  'tale-02': require('../../../../../elements/images/egypt_falcon_shrine.png'),
  'tale-03': require('../../../../../elements/images/india_moonlit_river.png'),
  'tale-04': require('../../../../../elements/images/mesoamerica_crimson_dusk.png'),
  'tale-05': require('../../../../../elements/images/greece_coastal_wreck.png'),
  'tale-06': require('../../../../../elements/images/egypt_obsidian_arch.png'),
  'tale-07': require('../../../../../elements/images/india_temple_grove.png'),
  'tale-08': require('../../../../../elements/images/mesoamerica_underground_city.png'),
  'tale-09': require('../../../../../elements/images/greece_silver_lyre.png'),
  'tale-10': require('../../../../../elements/images/egypt_moon_chamber.png'),
  'tale-11': require('../../../../../elements/images/india_emerald_court.png'),
  'tale-12': require('../../../../../elements/images/mesoamerica_amber_eclipse.png'),
};
...
const assembleChronicle = (
  ...
  forkCaptionA: string,
  forkCaptionB: string,
  branchScriptA: RadienceffAncienttalesBranchScript,
  branchScriptB: RadienceffAncienttalesBranchScript,
): Omit<RadienceffAncienttalesChronicleEntry, 'coverVisual'> => ({
  ...meta,
  passageMap: {
    start: {
...
const chronicleDrafts: Omit<RadienceffAncienttalesChronicleEntry, 'coverVisual'>[] = [
  assembleChronicle(
    {
      entryKey: 'tale-01',
      localeTag: 'Greece',
...
export const radienceffAncienttalesChronicleCatalog: RadienceffAncienttalesChronicleEntry[] = chronicleDrafts.map(
  chronicle => ({
    ...chronicle,
...
export const radienceffAncienttalesMythLocaleSequence: RadienceffAncienttalesMythLocale[] = [
  'Greece',
  'Egypt',
  'India',
  'Aztecs',
...
export const radienceffAncienttalesResolveChronicle = (entryKey: string) =>
  radienceffAncienttalesChronicleCatalog.find(s => s.entryKey === entryKey);

export const radienceffAncienttalesChroniclesGroupedByLocale = radienceffAncienttalesMythLocaleSequence.map(localeTag => ({
  localeTag,
  groupedEntries: radienceffAncienttalesChronicleCatalog.filter(s => s.localeTag === localeTag),
}));
