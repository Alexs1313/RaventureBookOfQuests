...
export const radienceffAncienttalesNormalizeTaleEntryKey = (entryKey: string) =>
  resolveAlias(entryKey, taleEntryKeyAliases);

export const radienceffAncienttalesNormalizeFigureEntryKey = (entryKey: string) =>
  resolveAlias(entryKey, figureEntryKeyAliases);

export const radienceffAncienttalesNormalizeRelicEntryKey = (entryKey: string) =>
  resolveAlias(entryKey, relicEntryKeyAliases);

export const radienceffAncienttalesNormalizeJokeKey = (jokeKey: string) =>
  resolveAlias(jokeKey, jokeKeyAliases);

export const radienceffAncienttalesNormalizePromptEntryKey = (entryKey: string) =>
  resolveAlias(entryKey, promptEntryKeyAliases);

export const radienceffAncienttalesNormalizeStoredTaleKeys = (entryKeys: string[]) => [
  ...new Set(entryKeys.map(radienceffAncienttalesNormalizeTaleEntryKey)),
];
