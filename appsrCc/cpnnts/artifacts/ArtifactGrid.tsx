...
const tileSpan = (Dimensions.get('window').width - 48.2 - 12.3) / 2;
        ...
        <View style={styles.grid}>
          {unlocked.map((artifact, index) => (
            <StaggerItem key={artifact.entryKey} index={index}>
              <ArtifactCard artifact={artifact} width={tileSpan} />
            </StaggerItem>
          ))}
        </View>
      </View>
        ...
        <View style={styles.grid}>
          {locked.map((artifact, index) => (
            <StaggerItem
              ...
              <LockedArtifactCard artifact={artifact} width={tileSpan} />
            </StaggerItem>
          ))}
        </View>
      </View>
