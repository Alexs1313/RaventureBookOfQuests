...
import {typewriterCharDelay} from '../../lnggkiiT/typewriter';
...
const TypewriterText = ({
  ...
  const showCaret =
    showCursor && visibleCount > 0 && visibleCount < text.length;

  return (
    <Text style={style}>
      {text.slice(0, visibleCount)}
      {showCaret ? <Text style={[style, styles.cursor]}>|</Text> : null}
    </Text>
  );
};
